import { Search, Filter, Star, Briefcase, Linkedin, ExternalLink } from 'lucide-react';
          ...
          {mentors.map((mentor) => (
            <div key={mentor.id} className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-amber-200 hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="pt-4 border-t border-gray-50 flex gap-3">
                <button className="flex-1 py-2.5 bg-gray-900 text-white text-sm font-semibold rounded-xl hover:bg-amber-600 transition-colors">
                  View Profile
                </button>
